...
const Footer = () => {
  ...
  <div className="container px-5 py-8 mx-auto flex flex-col sm:flex-row items-center">
    ...
    <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start w-full sm:w-auto space-x-3">
      <a href="https://www.facebook.com/meherjaved440" className="text-gray-500 hover:text-indigo-600 transition-colors duration-200">
        <svg
          fill="currentColor"
          strokeLinecap="round"
          strokeLinejoin="round"
      ...
      <a href="https://x.com/meherjaved456" className="text-gray-500 hover:text-indigo-600 transition-colors duration-200">
        <svg
          fill="currentColor"
          strokeLinecap="round"
          strokeLinejoin="round"
      ...
      <a href="https://www.linkedin.com/in/muhammad-javed-383914200/" className="text-gray-500 hover:text-indigo-600 transition-colors duration-200">
        <svg
          fill="currentColor"
          stroke="currentColor"
          strokeLinecap="round"
